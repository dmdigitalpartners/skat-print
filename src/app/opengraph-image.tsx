...
// No explicit `runtime = 'edge'` here (removed): next/og's ImageResponse
// works fine on the default Node.js runtime, and staying off edge lets this
// route prerender statically instead of rendering per-request.
